...
public class UtilArquivo {
	...
	public static ArquivoProcessoLicitatorio converterArquivoParaPDF(ArquivoProcessoLicitatorio arquivo) {
	...
	public static ArquivoLei converterArquivoParaPDF(ArquivoLei arquivo) {
