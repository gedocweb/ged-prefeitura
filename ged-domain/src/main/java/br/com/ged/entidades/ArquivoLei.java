...
@Entity
@Table(name = "tb_arq_lei")
public class ArquivoLei extends EntidadeBasica{
	...
	@Id
	@Column(name = "id_arq_lei")
	@GeneratedValue(generator = "seq_arq_lei", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arq_lei", sequenceName = "seq_arq_lei",allocationSize=1)
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoLei)) {
			return false;
		}
		ArquivoLei other = (ArquivoLei) obj;
		if (contentType == null) {
