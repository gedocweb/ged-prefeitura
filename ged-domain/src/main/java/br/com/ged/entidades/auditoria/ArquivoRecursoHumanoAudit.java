...
@Entity
@Table(name = "tb_arquivo_rh_audit")
public class ArquivoRecursoHumanoAudit extends EntidadeBasicaAudit{
	...
	@Id
	@Column(name = "id_arquivo_rh_audit")
	@GeneratedValue(generator = "seq_arquivo_rh_audit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arquivo_rh_audit", sequenceName = "seq_arquivo_rh_audit",allocationSize=1)
	private Long id;
	...
	public ArquivoRecursoHumanoAudit(){
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoRecursoHumanoAudit)) {
			return false;
		}
		ArquivoRecursoHumanoAudit other = (ArquivoRecursoHumanoAudit) obj;
		if (contentType == null) {
