...
public class TipoDocumentoAudit extends EntidadeBasicaAudit implements Comparable<TipoDocumentoAudit>{
	...
	@Id
	@Column(name = "id_tp_doc_audit")
	@GeneratedValue(generator = "seq_tp_doc_audit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_tp_doc_audit", sequenceName = "seq_tp_doc_audit",allocationSize=1)
	private Long id;
