...
@Entity
@Table(name = "tb_arquivo_rh")
public class ArquivoRecursoHumano extends EntidadeBasica{
	...
	@Id
	@Column(name = "id_arquivo_rh")
	@GeneratedValue(generator = "seq_arquivo_rh", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arquivo_rh", sequenceName = "seq_arquivo_rh",allocationSize=1)
	private Long id;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoRecursoHumano)) {
			return false;
		}
		ArquivoRecursoHumano other = (ArquivoRecursoHumano) obj;
		if (contentType == null) {
