...
@Entity
@Table(name = "tb_arq_proc_licit")
public class ArquivoProcessoLicitatorio extends EntidadeBasica{
	...
	@Id
	@Column(name = "id_arq_proc_licit")
	@GeneratedValue(generator = "seq_arq_proc_licit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arq_proc_licit", sequenceName = "seq_arq_proc_licit",allocationSize=1)
	private Long id;
	...
	public ArquivoProcessoLicitatorio(){
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoProcessoLicitatorio)) {
			return false;
		}
		ArquivoProcessoLicitatorio other = (ArquivoProcessoLicitatorio) obj;
		if (contentType == null) {
