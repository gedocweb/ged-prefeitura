...
public class ArquivoLeiAudit extends EntidadeBasicaAudit{
	...
	@Id
	@Column(name = "id_arq_lei_audit")
	@GeneratedValue(generator = "seq_arq_lei_audit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arq_lei_audit", sequenceName = "seq_arq_lei_audit",allocationSize=1)
	private Long id;
