...
@Entity
@Table(name = "tb_arq_lei_audit")
public class ArquivoLeiAudit extends EntidadeBasicaAudit{
	...
	public ArquivoLeiAudit(ArquivoLei arquivo, TipoOperacaoAudit tpAudit, Long dateMili) {
		
		ArquivoLeiAuditPK pk = new ArquivoLeiAuditPK();
	...
	public ArquivoLeiAudit(){
		situacao = Situacao.ATIVO;
	}

	public ArquivoLeiAuditPK getId() {
		return id;
	}

	public void setId(ArquivoLeiAuditPK id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoLeiAudit)) {
			return false;
		}
		ArquivoLeiAudit other = (ArquivoLeiAudit) obj;
		if (contentType == null) {
