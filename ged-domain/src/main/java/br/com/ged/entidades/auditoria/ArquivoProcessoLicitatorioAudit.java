...
@Entity
@Table(name = "tb_arq_proc_licit_audit")
public class ArquivoProcessoLicitatorioAudit extends EntidadeBasicaAudit{
	...
	@Id
	@Column(name = "id_arq_proc_licit_audit")
	@GeneratedValue(generator = "seq_arq_proc_licit_audit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arq_proc_licit_audit", sequenceName = "seq_arq_proc_licit_audit",allocationSize=1)
	private Long id;
	...
	public ArquivoProcessoLicitatorioAudit(){
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof ArquivoProcessoLicitatorioAudit)) {
			return false;
		}
		ArquivoProcessoLicitatorioAudit other = (ArquivoProcessoLicitatorioAudit) obj;
		if (contentType == null) {
