...
@Entity
@Table(name = "tb_arquivo_doc_audit")
public class ArquivoAudit extends EntidadeBasicaAudit{
	...
	@Id
	@Column(name = "id_arquivo_audit")
	@GeneratedValue(generator = "seq_arquivo_doc_audit", strategy = GenerationType.AUTO)
	@SequenceGenerator(name = "seq_arquivo_doc_audit", sequenceName = "seq_arquivo_doc_audit",allocationSize=1)
	private Long id;
