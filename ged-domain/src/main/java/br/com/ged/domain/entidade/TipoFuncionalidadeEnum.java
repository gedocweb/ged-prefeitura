...
public enum TipoFuncionalidadeEnum {
	...
	PESQUISAR_DOCUMENTO("Pesquisar Documentos", FuncionalidadeEnum.MANTER_DOCUMENTO, TipoApp.TODOS, Role.ADMIN, Role.GERENTE),
	...
	PESQUISAR_BALANCETE("Pesquisar Balancete", FuncionalidadeEnum.MANTER_BALANCETE, TipoApp.PREFEITURA, Role.ADMIN, Role.GERENTE),

	//Processo licitatorio
	PESQUISAR_PROCESSO_LICITATORIO("Pesquisar Processo Licitatório", FuncionalidadeEnum.MANTER_PROCESSO_LICITATORIO, TipoApp.PREFEITURA, Role.ADMIN, Role.GERENTE),
	...
	PESQUISAR_LEI("Pesquisar Lei", FuncionalidadeEnum.MANTER_LEI, TipoApp.PREFEITURA, Role.ADMIN, Role.GERENTE),
	...
	MONITORAR_OPERACAO("Monitoramento dos usuários", FuncionalidadeEnum.RELATORIO, TipoApp.TODOS, Role.ADMIN, Role.GERENTE),
	DETALHAR_OPERACAO("Detalhar operação", FuncionalidadeEnum.RELATORIO, TipoApp.TODOS, Role.ADMIN, Role.GERENTE),
	DOSSIE_OPERACAO("Dossiê da operação", FuncionalidadeEnum.RELATORIO, TipoApp.TODOS, Role.ADMIN, Role.GERENTE)
