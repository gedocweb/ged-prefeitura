...
import br.com.ged.generics.model.GenericPersistenceAudit;

@Stateless
public class GenericServiceAuditImpl<T extends EntidadeBasicaAudit, ID extends Serializable> implements GenericServiceAudit<T, ID>{
	
	@EJB
	private GenericPersistenceAudit<T, ID> reposiroty;
